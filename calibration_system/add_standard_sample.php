...
if (isset($_POST['submit'])) {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO standard_samples
            (item_no, description, equipment_code, model, maker, model_maker, serial_no,
             location, section, manager, reference, calibration_date, next_calibration_date,
             calibration_frequency, calibrator, cal_type, env_type, present_status, remarks)
            VALUES
            (:item_no, :description, :equipment_code, :model, :maker, :model_maker, :serial_no,
             :location, :section, :manager, :reference, :calibration_date, :next_calibration_date,
             :calibration_frequency, :calibrator, :cal_type, :env_type, :present_status, :remarks)");
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="model_maker" id="model_maker_display"
                               class="auto-value-green" readonly placeholder="Filled from Model + Maker">
                    </div>
                    ...
                    <div class="form-group">
                        <label>Section</label>
                        <input type="text" name="section" <?= $isGuest ? 'readonly class="readonly"' : '' ?>>
                    </div>

                    <div class="form-group">
                        <label>Manager</label>
                        <input type="text" name="manager" <?= $isGuest ? 'readonly class="readonly"' : '' ?>>
                    </div>

                    <div class="form-group">
                        <label>Reference</label>
                        <input type="text" name="reference" class="mono-input" <?= $isGuest ? 'readonly class="readonly"' : '' ?>>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($isGuest): ?><input type="hidden" name="cal_type" value=""><?php endif; ?>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($isGuest): ?><input type="hidden" name="env_type" value=""><?php endif; ?>
                    </div>
                    ...
                    <div class="form-group span-full">
                        ...
                        <textarea name="remarks" rows="3"
                                  ...
                                  style="padding:8px 12px;resize:vertical;line-height:1.55;min-height:72px;"></textarea>
                    </div>
