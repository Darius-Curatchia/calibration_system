...
(function () {
    ...
    var collapsed = (s !== '0'); /* default collapsed unless explicitly expanded */
...
const ROOM_NAMES = { cal: 'Calibration Room', insp: 'Inspection Room', cal_ext: 'Calibration Extension Room' };
